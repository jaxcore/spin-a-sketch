  ...
  render() {
    return (
      <div className="App">
        ...
        <SketchCanvas leftPosition={this.state.leftPosition} rightPosition={this.state.rightPosition} events={this.events} ref={this.refSketch} edgeSize={this.state.edgeSize}  spinV={this.spinV} spinH={this.spinH} />
        <PixiKnobs leftPosition={this.state.leftPosition} rightPosition={this.state.rightPosition} edgeSize={this.state.edgeSize} spinV={this.spinV} spinH={this.spinH} />
      </div>
    );
  }
